    ...
    <body>
        ...
        <div class="container text-center container-fluid">
            <div class="row">
                ...
                <div class="col">
                    <br>
                    <h2 class=" text-center container">¡Registra tus Datos!</h2>
                    <form action="Controlador"> 
                        ...
                        <input type="submit" class="btn btn-danger" name="accion" value="Cancelar">
                    </form>
                    <br>
                    <a href="index.jsp"class="btn btn-light bg-dark text-white">Volver al inicio</a>
                </div>
                <div class="col">
                </div>
            </div>
